...
cc.Class({
    ...
    onLoad () {
        // 初始化敌人参数
        this.name = enemy2_info.name;
        this.blood_volume = enemy2_info.blood_volume;
        this.fight_volume = enemy2_info.fight_volume;
        this.defense_volume = enemy2_info.defense_volume;
    ...
    start () {
        ...
        }.bind(this), utils.random_int(10, 15));
    },
        ...
        if(this.injured_anim_flag == 0) {
            ...
            if(this.blood_volume <= 0){ // 敌人死亡  播放死亡动画
                ...
                this.play_anim[4].play_once(function() {
                    ...
                    // 数量减一
                    map1_info.enemy2_num --;
                    map1_info.player_score += 10;
                    this.destroy();
